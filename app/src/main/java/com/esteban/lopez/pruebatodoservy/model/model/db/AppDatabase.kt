...
import com.esteban.lopez.pruebatodoservy.model.model.db.type_converters.LocalDateConverter
...
@TypeConverters(TaskStatusConverter::class, LocalTimeConverter::class, LocalDateConverter::class)
